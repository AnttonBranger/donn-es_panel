...
```
On rejette l'hypothèse nulle donc on garde le modèle à effets fixes. On accepte que l'hétérogénéité inobservée soit corrélée avec la variable ln_labor_inc. 

# Question 14

a) 
```{r}
my_model2 <- my_model <- ln_workhours ~ ln_labor_inc + education + age
```
